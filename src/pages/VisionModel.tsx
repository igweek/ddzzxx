...
export default function VisionModel() {
  ...
  return (
    <div className="h-full max-w-7xl mx-auto p-8 flex flex-col">
      {/* Tab Selector */}
      <div className="shrink-0 flex space-x-1 bg-white border border-[#E5E5E7] p-1 rounded-2xl w-fit shadow-sm relative overflow-hidden mb-8">
        <div 
          className={cn(
      ...
      {activeTab === 'feed' ? (
        <div className="flex-1 min-h-0 grid grid-cols-1 lg:grid-cols-3 gap-8 animate-in fade-in slide-in-from-bottom-2 duration-300">
          ...
          <div className="lg:col-span-2 flex flex-col gap-4 min-h-0">
            <div className="relative w-full flex-1 min-h-0 bg-[#F5F5F7] rounded-3xl overflow-hidden shadow-sm border border-[#E5E5E7]">
              <img 
        ...
        <div className="flex-1 min-h-0 grid grid-cols-1 lg:grid-cols-3 gap-8 animate-in fade-in slide-in-from-bottom-2 duration-300">
          ...
          <div className="lg:col-span-2 flex flex-col gap-4 min-h-0">
            <div className="relative w-full flex-1 min-h-0 bg-[#000] rounded-3xl border border-[#E5E5E7] overflow-hidden shadow-sm group">
              <video 
                ref={videoRef}
                className="absolute inset-0 w-full h-full object-cover" 
                autoPlay 
            ...
            <div className="bg-white border border-[#E5E5E7] rounded-2xl overflow-hidden shadow-sm flex flex-col max-h-48 shrink-0">
              <div className="grid grid-cols-4 bg-[#F5F5F7] p-4 text-[10px] font-black text-[#86868B] uppercase tracking-widest border-b border-[#E5E5E7] shrink-0">
                <div>Track ID</div>
                <div>状态</div>
                <div>累计距离 (m)</div>
                <div>即时速度 (m/s)</div>
              </div>
              <div className="divide-y divide-[#F5F5F7] overflow-y-auto custom-scrollbar">
