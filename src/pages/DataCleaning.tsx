...
export default function DataCleaning() {
  ...
  return (
    <div className="h-full p-8 flex flex-col max-w-[1600px] mx-auto">
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 flex-1 min-h-0">
        {/* Left Panel */}
        <aside className="lg:col-span-1 h-full overflow-y-auto custom-scrollbar pr-2">
          <div className="bg-white p-8 rounded-[2rem] border border-[#E5E5E7] shadow-sm flex flex-col min-h-full">
        ...
        {/* Main Content */}
        <main className="lg:col-span-3 bg-white p-8 rounded-[2rem] border border-[#E5E5E7] shadow-sm flex flex-col h-full overflow-hidden">
