...
export default function DataCleaning() {
  ...
  return (
    <div className="w-full h-full p-8 flex flex-col min-h-0">
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 flex-1 min-h-0">
        {/* Left Panel */}
        <aside className="lg:col-span-1 h-full min-h-0">
          <div className="bg-white p-8 rounded-[2rem] border border-[#E5E5E7] shadow-sm flex flex-col h-full overflow-y-auto custom-scrollbar">
        ...
        {/* Main Content */}
        <main className="lg:col-span-3 bg-white p-10 rounded-[2.5rem] border border-[#E5E5E7] shadow-sm flex flex-col h-full min-h-0">
