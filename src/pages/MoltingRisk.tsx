...
export default function MoltingRisk() {
  ...
  return (
    <div className="w-full mx-auto lg:h-full p-4 md:p-8 flex flex-col lg:min-h-0">
      <div className="flex flex-col xl:flex-row gap-8 flex-1 lg:min-h-0">
        {/* Logic Gates */}
        <div className="w-full xl:w-[380px] shrink-0 lg:h-full lg:min-h-0 lg:overflow-y-auto custom-scrollbar flex flex-col gap-6 lg:pr-2">
        ...
        {/* Main Chart Column */}
        <div className="flex-1 bg-white rounded-[2rem] p-6 lg:p-8 shadow-sm border border-[#E5E5E7] flex flex-col lg:h-full lg:min-h-0 min-w-0 h-[500px] lg:h-auto">
