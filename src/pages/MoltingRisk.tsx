  ...
  return (
    <div className="h-full flex flex-col max-w-7xl mx-auto p-8">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 flex-1 min-h-0">
        {/* Logic Gates */}
        <div className="lg:col-span-4 flex flex-col gap-6 overflow-y-auto custom-scrollbar pr-2 h-full">
          <div className="bg-white rounded-[2rem] p-6 shadow-sm border border-[#E5E5E7] shrink-0">
            ...
            <div className={cn(
              "mt-4 p-4 rounded-2xl border text-center transition-all",
              ...
              "bg-white border-green-500 shadow-lg shadow-green-500/10"
               ...
               <h3 className={cn(
                 "font-black text-lg tracking-tighter mb-1 flex items-center justify-center gap-2",
            ...
            <button 
              onClick={togglePlay}
              className={cn(
                "w-full mt-4 py-3 rounded-2xl font-bold flex items-center justify-center gap-2 transition-all active:scale-95",
        ...
        {/* Main Chart Column */}
        <div className="lg:col-span-8 bg-white rounded-[2rem] p-8 shadow-sm border border-[#E5E5E7] flex flex-col h-full">
