  ...
  return (
    <div className="w-full mx-auto h-full p-8 flex flex-col min-h-0">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 flex-1 min-h-0">
        {/* Logic Gates */}
        <div className="lg:col-span-4 h-full min-h-0 overflow-y-auto custom-scrollbar flex flex-col gap-6 pr-2">
        ...
        {/* Main Chart Column */}
        <div className="lg:col-span-8 bg-white rounded-[2rem] p-8 shadow-sm border border-[#E5E5E7] flex flex-col h-full min-h-0">
