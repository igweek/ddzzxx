...
export default function WaterQuality() {
  ...
  return (
    <div className="flex flex-col lg:flex-row h-full gap-8 overflow-hidden p-8 min-h-0">
      {/* Left Panel */}
      <div className="lg:w-[400px] shrink-0 flex flex-col bg-white border border-[#E5E5E7] p-8 rounded-[2rem] shadow-sm overflow-y-auto custom-scrollbar h-full min-h-0">
      ...
      {/* Right Plot */}
      <div className="flex-1 bg-white border border-[#E5E5E7] p-8 rounded-[2rem] shadow-sm flex flex-col relative overflow-hidden h-full min-h-0">
        ...
        <div className="flex-1 flex items-center justify-center relative backdrop-blur-[1px] min-h-0">
          <div className="relative group w-full h-full max-w-[600px] max-h-[600px] flex items-center justify-center">
            <canvas 
              ref={canvasRef}
              width={600}
              height={600}
