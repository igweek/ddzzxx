...
export default function WaterQuality() {
  ...
  return (
    <div className="flex h-full gap-8 overflow-hidden p-8 max-w-[1400px] mx-auto w-full">
      {/* Left Panel */}
      <div className="w-[400px] flex flex-col bg-white border border-[#E5E5E7] p-8 rounded-[2rem] shadow-sm overflow-y-auto custom-scrollbar shrink-0">
      ...
      {/* Right Plot */}
      <div className="flex-1 min-w-0 bg-white border border-[#E5E5E7] p-8 rounded-[2rem] shadow-sm flex flex-col relative overflow-hidden">
