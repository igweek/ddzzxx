...
export default function SmartFeeding() {
  ...
  return (
    <div className="w-full mx-auto h-full p-8 flex flex-col min-h-0">
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-8 flex-1 min-h-0">
        ...
        <div className="xl:col-span-3 h-full min-h-0">
          <div className="bg-white border border-[#E5E5E7] rounded-3xl p-6 shadow-sm relative overflow-hidden flex flex-col h-full overflow-y-auto custom-scrollbar">
        ...
        <div className="xl:col-span-9 bg-white border border-[#E5E5E7] rounded-3xl p-8 flex flex-col shadow-sm relative h-full min-h-0">
          <h2 className="text-xl font-bold text-[#1D1D1F] flex items-center gap-2 mb-6 border-b border-gray-50 pb-6 relative z-10 shrink-0">
            <GitBranch className="text-[#007AFF] w-6 h-6" /> 智能投喂模型
            <span className="ml-4 text-[10px] font-bold text-[#86868B] bg-gray-100 px-3 py-1 rounded-full uppercase tracking-widest hidden sm:inline-block">
              Live Neural Simulation (100 Trees)
            </span>
          </h2>

          {/* 100 Trees Grid */}
          <div className="flex-1 overflow-y-auto min-h-0 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 mb-8 relative z-10 pr-2 custom-scrollbar">
