...
export default function SmartFeeding() {
  ...
  return (
    <div className="max-w-[1400px] mx-auto h-full p-8 flex flex-col">
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-8 flex-1 min-h-0">
        {/* Left Monitor Section */}
        <div className="xl:col-span-3 overflow-y-auto custom-scrollbar pr-2 h-full">
          <div className="bg-white border border-[#E5E5E7] rounded-3xl p-6 shadow-sm relative overflow-hidden flex flex-col min-h-full">
        ...
        <div className="xl:col-span-9 bg-white border border-[#E5E5E7] rounded-3xl p-8 flex flex-col shadow-sm relative h-full overflow-hidden">
          ...
          {/* 100 Trees Grid */}
          <div className="flex-1 min-h-0 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 mb-8 relative z-10 overflow-y-auto pr-2 custom-scrollbar">
          ...
          {/* Aggregation area */}
          <div className="mt-auto shrink-0 relative z-10 h-[240px]">
